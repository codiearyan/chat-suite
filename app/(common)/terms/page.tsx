...
export const metadata: Metadata = {
  title: "Terms and Conditions | Pivot With AI",
  description: "Terms and conditions for using Pivot With AI services",
};

function getTermsContent() {
  const filePath = path.join(process.cwd(), "app/(common)/terms/content.md");
