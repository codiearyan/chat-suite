...
export const metadata: Metadata = {
  title: "Refund Policy | Pivot With AI",
  description: "Refund policy for using Pivot With AI services",
};

function getRefundContent() {
  const filePath = path.join(process.cwd(), "app/(common)/refund/content.md");
  const content = fs.readFileSync(filePath, "utf8");
  return content;
}

export default function RefundPage() {
  const content = getRefundContent();
