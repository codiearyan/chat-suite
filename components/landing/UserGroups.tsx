        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {userGroups.map((group, index) => (
            ...
            >
              {/* Card */}
              <div
                className="relative h-full p-8 rounded-2xl bg-slate-800/50 backdrop-blur-sm 
                            border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
              >
                {/* Glow Effect */}
                <div
                  className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-600/20 to-blue-600/20 
                ...
                <div className="relative flex flex-col items-center text-center">
                  ...
                  {/* Description */}
                  <p className="text-gray-300 leading-relaxed">{group.text}</p>
