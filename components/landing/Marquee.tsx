  ...
  return (
    ...
    >
      <div className="relative w-48 h-24 rounded-xl overflow-hidden">
        ...
        <div className={`absolute inset-0 bg-gradient-to-br ${partner.gradient} opacity-10 
                        group-hover:opacity-20 transition-opacity duration-300`} />
        
        {/* Animated Border */}
        <div className="absolute inset-0">
          <div className={`absolute inset-0 bg-gradient-to-r ${partner.gradient} opacity-0 
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 
          ...
          <div className="absolute inset-0 transform -rotate-45 translate-y-full 
